...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        if (!Queue) {
            const embed = new EmbedBuilder()
            .setDescription(`${client.emoji.wrong} | There's No Player To Resume In This Server!`)
            .setColor("Random")
        ...
        if (!Queue.currentTrack) {
            const embed = new EmbedBuilder()
            .setDescription(`${client.emoji.wrong} | There's No Track Playing To Resume In This Server!`)
            .setColor("Random")
        ...
        if (!Queue.node.isPaused()) {
            const embed = new EmbedBuilder()
            .setDescription(`${client.emoji.wrong} | The Player Is Already Playing!`)
            .setColor("Random")
        ...
        const embed = new EmbedBuilder()
        .setDescription(`${client.emoji.tick} | Resumed - [${Queue.currentTrack.title}](${Queue.currentTrack.url})!`)
        .setColor("Random")
